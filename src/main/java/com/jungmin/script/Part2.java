...
public class Part2 {
  ...
  */
  public static final String PART2_3 = "insert into users (username,email,password) values ('luke','jh4','test123')";
  ...
  */
  public static final String PART2_7 = "select p.title, u.username from users u " +
  ...
  */
  public static final String PART2_8 = "select p.title , u.username from users u " +
  ...
  */
  public static final String PART2_10 = "insert into posts (title, content, user_id) values ('hi','bye',1) ";

  /*
  ----------------------------------------------------------------------------------------------
      TODO: Q 2-11. 어느 board에도 속하지 않는 posts의 모든 데이터를 찾기위한 SQL을 작성해주세요.")
  */
  public static final String PART2_11 = "select p.* from posts p " +
  ...
  */
  public static final String PART2_13 = "select b.name from boards b " +
          "join posts p on p.board_id = b.board_id " +
          "where p.user_id = 1 ";
  ...
  */
  public static final String PART2_15 = "select count(c.user_id) as CommentCount from comments c " +
  ...
  */
  public static final String PART2_16 = "select u.username, count(c.comment_id) as CommentCount from users u " +
  ...
  */
  public static final String PART2_20 = "select t.name, count(pt.post_id) as PostCount from Post_Tags pt " +
          "right join Tags t on t.tag_id = pt.tag_id " +
          "group by t.name ";
}
